...
const ProductScreen = ({ history, match }) => {
  ...
  const [qty, setQty] = useState(1) // initially 0
                  ...
                  <ListGroup.Item>
                    <div>
                      ...
                      <Menu
                        ...
                        onClose={handleClose}
                      >
                        <MenuItem onClick={handleClose} className='tab1'>
                          RED
                        </MenuItem>
                        <MenuItem onClick={handleClose} className='tab2'>
                          YELLOW
                        </MenuItem>
                        <MenuItem onClick={handleClose} className='tab3'>
                          BLUE
                        </MenuItem>
                        <MenuItem onClick={handleClose} className='tab4'>
                          GREEN
                        </MenuItem>
                      </Menu>
                    </div>
